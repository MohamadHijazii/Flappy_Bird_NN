...
public class TrianglesSpawner : MonoBehaviour
{
    ...
    void SpawnObstacle()
    {
        ...
        float x = UnityEngine.Random.Range(-1, 2f);
        Vector3 toSpawn = new Vector3(x+transform.position.x,transform.position.y);
